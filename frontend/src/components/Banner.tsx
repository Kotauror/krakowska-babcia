...
export default function Banner() {
  return (
    <div className={mynerve.className}>
      ...
      />
      <h1 className="text-xl md:text-4xl font-bold text-center px-4 mt-8 mb-2">
        WYCIECZKI Z WNUKAMI
      </h1>
      <h2 className="text-l md:text-xl font-bold text-center px-2 m-2">
        I KILKA POMYSŁÓW NA DESZCZ
      </h2>
      <div className="justify-center text-center md:px-2 px-1 text-l md:text-2xl">
